...
const CACHE = 'fichaje-mn-v7';
const SHELL = [
  '/', '/index.html',
  '/css/styles.css', '/js/app.js', '/js/common.js', '/js/fichar.js', '/js/mis-fichajes.js', '/js/admin.js',
  '/manifest.json', '/img/icon.svg',
  // Tipografía autoalojada: el kiosko debe verse igual sin conexión.
  '/fonts/geist-latin.woff2', '/fonts/geist-latin-ext.woff2', '/fonts/geist-mono-latin.woff2', '/fonts/instrument-serif-italic.woff2', '/fonts/instrument-serif.woff2',
];
